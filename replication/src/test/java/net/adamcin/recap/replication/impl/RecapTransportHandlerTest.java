...
public class RecapTransportHandlerTest {
    ...
    public void testGetAgentAddress() {
        ...
        try {
            agentAddress = RecapTransportHandler.getAgentAddress(mockConfig);
    ...
    public void testReplicationLogProgressListenerAtLeast() {
        assertTrue("DEBUG is at least DEBUG",
                RecapTransportHandler.ReplicationLogProgressListener.atLeast(
    ...
    class MockTransportAgentConfig implements AgentConfig {

        String uri;
        String username;
        String password;

        MockTransportAgentConfig(String uri, String username, String password) {
            this.uri = uri;
